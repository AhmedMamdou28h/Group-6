...
o	Created a Dim_Date table (Date Dimension).
o	Created a Dim_Transport_Type table (Transport Dimension).
o	Created a Fact_Ridership table (Fact Table) containing the measures (Total_Ridership, Pre_Pandemic_Percent).
o	Established relationships between the tables.
3.	Dashboard Design (UI/UX): Designed an interactive dashboard focused on clarity and key insights.
4.	Insights & Recommendations: Analyzed the final visuals to derive conclusions about recovery trends.
